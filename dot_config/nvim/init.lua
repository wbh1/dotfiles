...
-- Enable spell checking on markdown files
...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    dependencies = {
      ...
      -- allows loading of vscode settings.json
      'folke/neoconf.nvim',
    },
    config = function()
  ...
  { -- Autocompletion
    ...
    opts = {
      keymap = {
        ...
        ['<C-y>'] = { 'accept', 'fallback' },
        -- Manually trigger a completion from blink.cmp.
      ...
      statusline.setup {
        ...
        content = {
          active = function()
            ...
            -- local ts = require('nvim-treesitter.statusline').statusline(90)
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ...
      highlight = {
        enable = true,
        -- disable treesitter highlighting on Saltstack files
        disable = function(lang, buf)
          local filename = vim.api.nvim_buf_get_name(buf)
          return lang == 'yaml' and filename:match '%.sls$'
        end,
