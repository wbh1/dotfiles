...
- YOU MUST get Will's explicit approval before implementing ANY backward compatibility.
...
- YOU MUST NEVER write tests that "test" mocked behavior. If you notice tests that test mocked behavior instead of real logic, you MUST stop and warn Will about them.
...
- You MUST NEVER discard tasks from your TodoWrite todo list without Will's explicit approval
